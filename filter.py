...
# 常见国家/地区代码转中文映射字典（没有在里面的会直接显示代码本身）
COUNTRY_MAP = {
    ...
    "GA": "加蓬", "GB": "英国", "UK": "英国", "GD": "格林纳达", "GE": "格鲁吉亚", "GF": "法属圭亚那", 
...
def check_ip(item):
    ...
    try:
        # 慢工出细活：超时时间给足 2.5 秒，确保偏远高延迟国家也能测出来
