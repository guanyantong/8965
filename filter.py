...
def main():
    ...
    print(f"大功告成！已精选出 {len(selected_nodes)} 个优质 IP，并成功扩展生成 {len(selected_nodes) * len(CF_HTTPS_PORTS)} 个全端口节点！")
